...
<head>
    ...
    <!-- x-editor CSS
        ============================================ -->
    <link rel="stylesheet" href="{{ URL::asset('master/css/editor/select2.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('master/css/editor/datetimepicker.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('master/css/editor/bootstrap-editable.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('master/css/editor/x-editor-style.css') }}">
    <!-- normalize CSS
        ============================================ -->
    <link rel="stylesheet" href="{{ URL::asset('master/css/data-table/bootstrap-table.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('master/css/data-table/bootstrap-editable.css') }}">
    <!-- style CSS
		============================================ -->
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="{{ url('auth/admin') }}"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Dashboard v.1</span></a></li>
      ...
      <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="{{ url('auth/admin') }}"><img class="main-logo" src="img/logo/logo.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="{{ url('auth/logout') }}"><span class="fa fa-lock author-log-ic"></span>Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="{{ url('auth/admin') }}">Dashboard v.1</a></li>
